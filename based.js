...
`));
  ...
  if (connection === 'close') {
    ...
    if (reason === DisconnectReason.badSession && !global.connectionMessagesPrinted.badSession) {
      console.log(chalk.bold.redBright(`\n╭━━━💀 𝐃𝐀𝐍𝐆𝐄𝐑 𝐄𝐑𝐑𝐎𝐑 ━━━╮\n│ ⚠️ 𝐒𝐞𝐬𝐬𝐢𝐨𝐧𝐞 𝐜𝐨𝐫𝐫𝐨𝐭𝐭𝐚, 𝐞𝐥𝐢𝐦𝐢𝐧𝐚 𝐥𝐚 𝐜𝐚𝐫𝐭𝐞𝐥𝐥𝐚 ${global.authFile} 𝐞𝐝 𝐞𝐬𝐞𝐠𝐮𝐢 𝐧𝐮𝐨𝐯𝐚𝐦𝐞𝐧𝒕𝐞 𝐢𝐥 𝐫𝐢𝐭𝐮𝐚𝐥𝐞.\n╰━━━━━━━━━━━━━━━━━━━━━╯`));
      global.connectionMessagesPrinted.badSession = true;
      process.exit(1);
    } else if (reason === DisconnectReason.loggedOut && !global.connectionMessagesPrinted.loggedOut) {
      console.log(chalk.bold.redBright(`\n╭━━━💀 𝐃𝐀𝐍𝐆𝐄𝐑 𝐄𝐑𝐑𝐎𝐑 ━━━╮\n│ ⚠️ 𝐂𝐨𝐧𝐧𝐞𝐬𝐬𝐢𝐨𝐧𝐞 𝐜𝐡𝐢𝐮𝐬𝐚 𝐝𝐚𝐥 𝐝𝐢𝐬𝐩𝐨𝐬𝐢𝐭𝐢𝐯ο, 𝐩𝐮𝐥𝐢𝐬𝐜𝐢 ${global.authFile} 𝐞 𝐫𝐢𝐬𝐜𝐚𝐧𝐬𝐢𝐨𝐧𝐚.\n╰━━━━━━━━━━━━━━━━━━━━━╯`));
      ...
      console.log(chalk.bold.yellowBright(`\n╭━━━🕷️ 𝐃𝐀𝐍𝐆𝐄𝐑 𝐖𝐀𝐑𝐍𝐈𝐍𝐆 ━━━╮\n│ ⚠️ 𝐂𝐨𝐧𝐧𝐞𝐬𝐬𝐢𝐨𝐧𝐞 𝐬𝐨𝐬𝐭𝐢𝐭𝐮𝐢𝐭𝐚. 𝐔𝐧'𝐚𝐥𝐭𝐫𝐚 𝐢𝐧𝐬𝐭𝐚𝐧𝐳𝐚 𝐡𝐚 𝐩𝐫𝐞𝐬𝐨 𝐢𝐥 𝐜𝐨𝐧𝐭𝐫𝐨𝐥𝐥ο.\n╰━━━━━━━━━━━━━━━━━━━━━━━╯`));
...
global.reloadHandler = async function (restatConn) {
  ...
  /* =========================================================================
     SICUREZZA SAFE-BIND: Protezione dagli handler undefined o mancanti
     ========================================================================= */
  conn.handler = handler.handler?.bind(global.conn) || (async () => {})
  conn.participantsUpdate = handler.participantsUpdate?.bind(global.conn) || (async () => {})
  conn.groupsUpdate = handler.groupsUpdate?.bind(global.conn) || (async () => {})
  conn.onDelete = handler.deleteUpdate?.bind(global.conn) || (async () => {})
  conn.onCall = handler.callUpdate?.bind(global.conn) || (async () => {})
